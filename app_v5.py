...
HINT = ("通關密語：遊戲開始", "通關密語：二一石", "通關密語：YZU牌子", "通關密語：蓮花們", "通關密語：極品王", "通關密語：1201")
...
def process_event(text: str):
    place = ["遊戲開始", "海豚1", "海豚2", "海豚3", "二一石拍照", "基哥1","基哥2","沒問題","地圖連接","上下樓","骰子","該你了"] 
    ...
    try:
        level_event = {0:level0, 1:level1, 2:level2, 3:level3, 4:level4, 5:level5, 6:level6, 7:level7, 8:level8, 9:level9, 10:level10 ,11:level11} 
        is_pass, textmessage, templatemessage, photo_urls ,video_urls = level_event[user.level](text) 
        ...
        return textmessage, templatemessage, photo_urls, video_urls 
